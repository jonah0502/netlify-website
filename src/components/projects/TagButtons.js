...
<nav className = "header tFlix">
  ...
  <li> <a className="btn btn-outline-light"  target="_blank" href="https://github.com/osu-cs290-sp21/final-project-tagflix"> <Github size={25} /></a></li>
  <li> <a className="btn btn-outline-light"  target="_blank" href="https://tagflix1.herokuapp.com/">Visit</a>
</li>  
</ul>
</nav>
</Router>
